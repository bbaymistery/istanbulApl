...
export const privacyKeywords = {
    ...
    "keywords": {
        ...
        "tr": "gizlilik politikası, veri koruma, GDPR uyumluluğu, kişisel bilgi güvenliği, APL Transfers gizlilik, veri toplama, çevrimiçi güvenlik",
        "zh": "隐私政策, 数据保护, GDPR 合规性, 个人信息安全, APL Transfers 隐私, 数据收集, 在线安全",
        "ar": "سياسة الخصوصية, حماية البيانات, الامتثال لـ GDPR, أمان المعلومات الشخصية, خصوصية APL Transfers, جمع البيانات, الأمان عبر الإنترنت",
        "ru": "политика конфиденциальности, защита данных, соответствие GDPR, безопасность персональных данных, конфиденциальность APL Transfers, сбор данных, интернет-безопасность",
        "es": "política de privacidad, protección de datos, cumplimiento de GDPR, seguridad de información personal, privacidad APL Transfers, recopilación de datos, seguridad en línea",
